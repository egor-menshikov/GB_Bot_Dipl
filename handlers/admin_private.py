...
@admin_rt.message(F.text == 'Ассортимент')
...
@admin_rt.callback_query(F.data.startswith('category_'))
...
@admin_rt.message(StateFilter(None), F.text == 'Добавить/Изменить баннер')
...
@admin_rt.message(AddBanner.image, F.photo)
...
@admin_rt.message(AddBanner.image)
...
@admin_rt.message(AddProduct.name, F.text)
...
@admin_rt.message(AddProduct.name)
...
@admin_rt.message(AddProduct.description, F.text)
...
@admin_rt.message(AddProduct.description)
async def add_description2(message: types.Message, state: FSMContext):
    await message.answer("Вы ввели не допустимые данные, введите текст описания товара")


# Ловим callback выбора категории
@admin_rt.callback_query(AddProduct.category)
...
@admin_rt.message(AddProduct.category)
...
@admin_rt.message(AddProduct.price, F.text)
...
@admin_rt.message(AddProduct.price)
...
@admin_rt.message(AddProduct.image)
